...
const showProducts = (products) => {
   ...
   setInnerText('total_products', products.length);//number of products 
...
const showProductDetailsInModal = (product_details) => {
   ...
   setInnerText('exampleModalLabel', product_details.title ? product_details.title : "No data");
   setInnerText('productId', product_details.id);
   setInnerText('modal_body', product_details.description ? product_details.description : "No Data");
